const Footer = () => {
  return (
    <footer className="footer bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700 text-white p-6 h-20 flex items-center justify-between shadow-lg">
      ...
      <nav className="flex space-x-6 md:justify-end">
        {[
          {
          ...
          <a
            ...
            aria-label={label}
            className="p-2 rounded-full transition transform hover:scale-110 hover:bg-white hover:text-indigo-700"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
